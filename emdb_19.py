...
#
# Generated Wed Apr  4 12:53:10 2018 by generateDS.py version 2.23a.
#
...
class adminType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='adminType', fromsubclass_=False, pretty_print=True):
        ...
        if self.lastUpdate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slastUpdate>%s</%slastUpdate>%s' % (namespace_, self.gds_format_date(self.lastUpdate, input_name='lastUpdate'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class depType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='depType', fromsubclass_=False, pretty_print=True):
        ...
        if self.depositionSite is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdepositionSite>%s</%sdepositionSite>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.depositionSite), input_name='depositionSite')), namespace_, eol_))
        if self.processingSite is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sprocessingSite>%s</%sprocessingSite>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.processingSite), input_name='processingSite')), namespace_, eol_))
        if self.headerReleaseDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sheaderReleaseDate>%s</%sheaderReleaseDate>%s' % (namespace_, self.gds_format_date(self.headerReleaseDate, input_name='headerReleaseDate'), namespace_, eol_))
        if self.mapReleaseDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smapReleaseDate>%s</%smapReleaseDate>%s' % (namespace_, self.gds_format_date(self.mapReleaseDate, input_name='mapReleaseDate'), namespace_, eol_))
        if self.obsoletedDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sobsoletedDate>%s</%sobsoletedDate>%s' % (namespace_, self.gds_format_date(self.obsoletedDate, input_name='obsoletedDate'), namespace_, eol_))
        ...
        if self.replaceExistingEntry is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sreplaceExistingEntry>%s</%sreplaceExistingEntry>%s' % (namespace_, self.gds_format_boolean(self.replaceExistingEntry, input_name='replaceExistingEntry'), namespace_, eol_))
        ...
        if self.inFrameEMDBId is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinFrameEMDBId>%s</%sinFrameEMDBId>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.inFrameEMDBId), input_name='inFrameEMDBId')), namespace_, eol_))
        ...
        if self.keywords is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%skeywords>%s</%skeywords>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.keywords), input_name='keywords')), namespace_, eol_))
...
class mapType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='mapType', fromsubclass_=False, pretty_print=True):
        ...
        if self.dataType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdataType>%s</%sdataType>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.dataType), input_name='dataType')), namespace_, eol_))
        ...
        if self.spaceGroupNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspaceGroupNumber>%s</%sspaceGroupNumber>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.spaceGroupNumber), input_name='spaceGroupNumber')), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
        ...
        if self.annotationDetails is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sannotationDetails>%s</%sannotationDetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.annotationDetails), input_name='annotationDetails')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class samplType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='samplType', fromsubclass_=False, pretty_print=True):
        ...
        if self.numComponents is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumComponents>%s</%snumComponents>%s' % (namespace_, self.gds_format_integer(self.numComponents, input_name='numComponents'), namespace_, eol_))
        ...
        if self.compDegree is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scompDegree>%s</%scompDegree>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.compDegree), input_name='compDegree')), namespace_, eol_))
        ...
        if self.molWtMethod is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smolWtMethod>%s</%smolWtMethod>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.molWtMethod), input_name='molWtMethod')), namespace_, eol_))
...
class processType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='processType', fromsubclass_=False, pretty_print=True):
        ...
        if self.method is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smethod>%s</%smethod>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.method), input_name='method')), namespace_, eol_))
...
class fittingType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='fittingType', fromsubclass_=False, pretty_print=True):
        ...
        if self.software is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssoftware>%s</%ssoftware>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.software), input_name='software')), namespace_, eol_))
        if self.refProtocol is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srefProtocol>%s</%srefProtocol>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.refProtocol), input_name='refProtocol')), namespace_, eol_))
        if self.targetCriteria is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stargetCriteria>%s</%stargetCriteria>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.targetCriteria), input_name='targetCriteria')), namespace_, eol_))
        if self.overallBValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%soverallBValue>%s</%soverallBValue>%s' % (namespace_, self.gds_format_float(self.overallBValue, input_name='overallBValue'), namespace_, eol_))
        if self.refSpace is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srefSpace>%s</%srefSpace>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.refSpace), input_name='refSpace')), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
    def build(self, node):
...
class smplCompType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='smplCompType', fromsubclass_=False, pretty_print=True):
        ...
        if self.entry is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sentry>%s</%sentry>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.entry), input_name='entry')), namespace_, eol_))
        if self.sciName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssciName>%s</%ssciName>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.sciName), input_name='sciName')), namespace_, eol_))
        if self.synName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssynName>%s</%ssynName>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.synName), input_name='synName')), namespace_, eol_))
        if self.molWtTheo is not None:
            self.molWtTheo.export(outfile, level, namespace_, name_='molWtTheo', pretty_print=pretty_print)
        if self.molWtExp is not None:
            self.molWtExp.export(outfile, level, namespace_, name_='molWtExp', pretty_print=pretty_print)
...
class contactType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='contactType', fromsubclass_=False, pretty_print=True):
        ...
        if self.familyName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfamilyName>%s</%sfamilyName>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.familyName), input_name='familyName')), namespace_, eol_))
        ...
        if self.fax is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfax>%s</%sfax>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.fax), input_name='fax')), namespace_, eol_))
...
class smplPrepType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='smplPrepType', fromsubclass_=False, pretty_print=True):
        ...
        if self.specimenState is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspecimenState>%s</%sspecimenState>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.specimenState), input_name='specimenState')), namespace_, eol_))
        ...
        if self.staining is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sstaining>%s</%sstaining>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.staining), input_name='staining')), namespace_, eol_))
        if self.specimenSupportDetails is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspecimenSupportDetails>%s</%sspecimenSupportDetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.specimenSupportDetails), input_name='specimenSupportDetails')), namespace_, eol_))
        ...
        if self.crystalGrowDetails is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scrystalGrowDetails>%s</%scrystalGrowDetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.crystalGrowDetails), input_name='crystalGrowDetails')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class vitrifType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='vitrifType', fromsubclass_=False, pretty_print=True):
        ...
        if self.cryogenName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scryogenName>%s</%scryogenName>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.cryogenName), input_name='cryogenName')), namespace_, eol_))
        if self.humidity is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%shumidity>%s</%shumidity>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.humidity), input_name='humidity')), namespace_, eol_))
        if self.temperature is not None:
            self.temperature.export(outfile, level, namespace_, name_='temperature', pretty_print=pretty_print)
        if self.instrument is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinstrument>%s</%sinstrument>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.instrument), input_name='instrument')), namespace_, eol_))
        if self.method is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smethod>%s</%smethod>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.method), input_name='method')), namespace_, eol_))
        if self.timeResolvedState is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stimeResolvedState>%s</%stimeResolvedState>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.timeResolvedState), input_name='timeResolvedState')), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
    def build(self, node):
...
class imgType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='imgType', fromsubclass_=False, pretty_print=True):
        ...
        if self.astigmatism is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sastigmatism>%s</%sastigmatism>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.astigmatism), input_name='astigmatism')), namespace_, eol_))
        if self.electronSource is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%selectronSource>%s</%selectronSource>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.electronSource), input_name='electronSource')), namespace_, eol_))
        ...
        if self.energyFilter is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%senergyFilter>%s</%senergyFilter>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.energyFilter), input_name='energyFilter')), namespace_, eol_))
        if self.imagingMode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%simagingMode>%s</%simagingMode>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.imagingMode), input_name='imagingMode')), namespace_, eol_))
        ...
        if self.illuminationMode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%silluminationMode>%s</%silluminationMode>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.illuminationMode), input_name='illuminationMode')), namespace_, eol_))
        if self.specimenHolder is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspecimenHolder>%s</%sspecimenHolder>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.specimenHolder), input_name='specimenHolder')), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
        if self.detector is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetector>%s</%sdetector>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.detector), input_name='detector')), namespace_, eol_))
        ...
        if self.calibratedMagnification is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scalibratedMagnification>%s</%scalibratedMagnification>%s' % (namespace_, self.gds_format_float(self.calibratedMagnification, input_name='calibratedMagnification'), namespace_, eol_))
        ...
        if self.microscope is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smicroscope>%s</%smicroscope>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.microscope), input_name='microscope')), namespace_, eol_))
        ...
        if self.specimenHolderModel is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspecimenHolderModel>%s</%sspecimenHolderModel>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.specimenHolderModel), input_name='specimenHolderModel')), namespace_, eol_))
        ...
        if self.nominalMagnification is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snominalMagnification>%s</%snominalMagnification>%s' % (namespace_, self.gds_format_float(self.nominalMagnification, input_name='nominalMagnification'), namespace_, eol_))
        ...
        if self.detectorDistance is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetectorDistance>%s</%sdetectorDistance>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.detectorDistance), input_name='detectorDistance')), namespace_, eol_))
        if self.electronBeamTiltParams is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%selectronBeamTiltParams>%s</%selectronBeamTiltParams>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.electronBeamTiltParams), input_name='electronBeamTiltParams')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class imgScanType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='imgScanType', fromsubclass_=False, pretty_print=True):
        ...
        if self.numDigitalImages is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumDigitalImages>%s</%snumDigitalImages>%s' % (namespace_, self.gds_format_integer(self.numDigitalImages, input_name='numDigitalImages'), namespace_, eol_))
        if self.scanner is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sscanner>%s</%sscanner>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.scanner), input_name='scanner')), namespace_, eol_))
        ...
        if self.odRange is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sodRange>%s</%sodRange>%s' % (namespace_, self.gds_format_float(self.odRange, input_name='odRange'), namespace_, eol_))
        if self.URLRawData is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sURLRawData>%s</%sURLRawData>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.URLRawData), input_name='URLRawData')), namespace_, eol_))
        if self.quantBitNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%squantBitNumber>%s</%squantBitNumber>%s' % (namespace_, self.gds_format_integer(self.quantBitNumber, input_name='quantBitNumber'), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
    def build(self, node):
...
class reconsType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='reconsType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ctfCorrection is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sctfCorrection>%s</%sctfCorrection>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.ctfCorrection), input_name='ctfCorrection')), namespace_, eol_))
        if self.resolutionByAuthor is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresolutionByAuthor>%s</%sresolutionByAuthor>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.resolutionByAuthor), input_name='resolutionByAuthor')), namespace_, eol_))
        if self.resolutionMethod is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresolutionMethod>%s</%sresolutionMethod>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.resolutionMethod), input_name='resolutionMethod')), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
        if self.eulerAnglesDetails is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%seulerAnglesDetails>%s</%seulerAnglesDetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.eulerAnglesDetails), input_name='eulerAnglesDetails')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class twoDxtalParamType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='twoDxtalParamType', fromsubclass_=False, pretty_print=True):
        ...
        if self.planeGroup is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%splaneGroup>%s</%splaneGroup>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.planeGroup), input_name='planeGroup')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class threeDxtalParamType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='threeDxtalParamType', fromsubclass_=False, pretty_print=True):
        ...
        if self.spaceGroup is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspaceGroup>%s</%sspaceGroup>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.spaceGroup), input_name='spaceGroup')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class helixParamType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='helixParamType', fromsubclass_=False, pretty_print=True):
        ...
        if self.axialSymmetry is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saxialSymmetry>%s</%saxialSymmetry>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.axialSymmetry), input_name='axialSymmetry')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class singPartType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='singPartType', fromsubclass_=False, pretty_print=True):
        ...
        if self.appliedSymmetry is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sappliedSymmetry>%s</%sappliedSymmetry>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.appliedSymmetry), input_name='appliedSymmetry')), namespace_, eol_))
        if self.numProjections is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumProjections>%s</%snumProjections>%s' % (namespace_, self.gds_format_integer(self.numProjections, input_name='numProjections'), namespace_, eol_))
        if self.numClassAverages is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumClassAverages>%s</%snumClassAverages>%s' % (namespace_, self.gds_format_integer(self.numClassAverages, input_name='numClassAverages'), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
    def build(self, node):
...
class subTomType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='subTomType', fromsubclass_=False, pretty_print=True):
        ...
        if self.numSubtomograms is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumSubtomograms>%s</%snumSubtomograms>%s' % (namespace_, self.gds_format_integer(self.numSubtomograms, input_name='numSubtomograms'), namespace_, eol_))
        if self.numClassAverages is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumClassAverages>%s</%snumClassAverages>%s' % (namespace_, self.gds_format_integer(self.numClassAverages, input_name='numClassAverages'), namespace_, eol_))
        if self.details is not None:
...
class tomogrType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tomogrType', fromsubclass_=False, pretty_print=True):
        ...
        if self.tiltAngleIncrement is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stiltAngleIncrement>%s</%stiltAngleIncrement>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.tiltAngleIncrement), input_name='tiltAngleIncrement')), namespace_, eol_))
        if self.numSections is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumSections>%s</%snumSections>%s' % (namespace_, self.gds_format_integer(self.numSections, input_name='numSections'), namespace_, eol_))
        if self.details is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetails>%s</%sdetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.details), input_name='details')), namespace_, eol_))
    def build(self, node):
...
class virusType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='virusType', fromsubclass_=False, pretty_print=True):
        ...
        if self.synSpeciesName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssynSpeciesName>%s</%ssynSpeciesName>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.synSpeciesName), input_name='synSpeciesName')), namespace_, eol_))
        if self.sciSpeciesSerotype is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssciSpeciesSerotype>%s</%ssciSpeciesSerotype>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.sciSpeciesSerotype), input_name='sciSpeciesSerotype')), namespace_, eol_))
        if self.sciSpeciesSerocomplex is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssciSpeciesSerocomplex>%s</%ssciSpeciesSerocomplex>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.sciSpeciesSerocomplex), input_name='sciSpeciesSerocomplex')), namespace_, eol_))
        if self.sciSpeciesSubspecies is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssciSpeciesSubspecies>%s</%ssciSpeciesSubspecies>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.sciSpeciesSubspecies), input_name='sciSpeciesSubspecies')), namespace_, eol_))
        if self.sciSpeciesStrain is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssciSpeciesStrain>%s</%ssciSpeciesStrain>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.sciSpeciesStrain), input_name='sciSpeciesStrain')), namespace_, eol_))
        if self.empty is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sempty>%s</%sempty>%s' % (namespace_, self.gds_format_boolean(self.empty, input_name='empty'), namespace_, eol_))
        if self.enveloped is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%senveloped>%s</%senveloped>%s' % (namespace_, self.gds_format_boolean(self.enveloped, input_name='enveloped'), namespace_, eol_))
        if self.isolate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sisolate>%s</%sisolate>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.isolate), input_name='isolate')), namespace_, eol_))
...
class shellType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='shellType', fromsubclass_=False, pretty_print=True):
        ...
        if self.nameElement is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snameElement>%s</%snameElement>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.nameElement), input_name='nameElement')), namespace_, eol_))
        if self.diameter is not None:
            self.diameter.export(outfile, level, namespace_, name_='diameter', pretty_print=pretty_print)
        if self.tNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stNumber>%s</%stNumber>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.tNumber), input_name='tNumber')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class proteinType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='proteinType', fromsubclass_=False, pretty_print=True):
        ...
        if self.oligomericDetails is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%soligomericDetails>%s</%soligomericDetails>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.oligomericDetails), input_name='oligomericDetails')), namespace_, eol_))
        if self.numCopies is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumCopies>%s</%snumCopies>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.numCopies), input_name='numCopies')), namespace_, eol_))
        if self.recombinantExpFlag is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srecombinantExpFlag>%s</%srecombinantExpFlag>%s' % (namespace_, self.gds_format_boolean(self.recombinantExpFlag, input_name='recombinantExpFlag'), namespace_, eol_))
...
class nuclAcidType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='nuclAcidType', fromsubclass_=False, pretty_print=True):
        ...
        if self.syntheticFlag is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssyntheticFlag>%s</%ssyntheticFlag>%s' % (namespace_, self.gds_format_boolean(self.syntheticFlag, input_name='syntheticFlag'), namespace_, eol_))
        ...
        if self.structure is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sstructure>%s</%sstructure>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.structure), input_name='structure')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class riboTypeEu(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='riboTypeEu', fromsubclass_=False, pretty_print=True):
        ...
        if self.eukaryote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%seukaryote>%s</%seukaryote>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.eukaryote), input_name='eukaryote')), namespace_, eol_))
        if self.sciSpeciesName is not None:
            self.sciSpeciesName.export(outfile, level, namespace_, name_='sciSpeciesName', pretty_print=pretty_print)
        if self.sciSpeciesStrain is not None:
            showIndent(outfile, level, pretty_print)
...
class riboTypePro(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='riboTypePro', fromsubclass_=False, pretty_print=True):
        ...
        if self.prokaryote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sprokaryote>%s</%sprokaryote>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.prokaryote), input_name='prokaryote')), namespace_, eol_))
        if self.sciSpeciesName is not None:
            self.sciSpeciesName.export(outfile, level, namespace_, name_='sciSpeciesName', pretty_print=pretty_print)
        if self.sciSpeciesStrain is not None:
            showIndent(outfile, level, pretty_print)
...
class externalReferencesType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='externalReferencesType', fromsubclass_=False, pretty_print=True):
        ...
        for refUniProt_ in self.refUniProt:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srefUniProt>%s</%srefUniProt>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(refUniProt_), input_name='refUniProt')), namespace_, eol_))
        for refGo_ in self.refGo:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srefGo>%s</%srefGo>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(refGo_), input_name='refGo')), namespace_, eol_))
        for refInterpro_ in self.refInterpro:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srefInterpro>%s</%srefInterpro>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(refInterpro_), input_name='refInterpro')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class natSrcVirusType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='natSrcVirusType', fromsubclass_=False, pretty_print=True):
        ...
        if self.hostCategory is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%shostCategory>%s</%shostCategory>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.hostCategory), input_name='hostCategory')), namespace_, eol_))
        ...
        if self.hostSpeciesStrain is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%shostSpeciesStrain>%s</%shostSpeciesStrain>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.hostSpeciesStrain), input_name='hostSpeciesStrain')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class natSrcType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='natSrcType', fromsubclass_=False, pretty_print=True):
        ...
        if self.organOrTissue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sorganOrTissue>%s</%sorganOrTissue>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.organOrTissue), input_name='organOrTissue')), namespace_, eol_))
        if self.cellLocation is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scellLocation>%s</%scellLocation>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.cellLocation), input_name='cellLocation')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class engSrcType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='engSrcType', fromsubclass_=False, pretty_print=True):
        ...
        if self.expSystemStrain is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sexpSystemStrain>%s</%sexpSystemStrain>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.expSystemStrain), input_name='expSystemStrain')), namespace_, eol_))
        if self.expSystemCell is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sexpSystemCell>%s</%sexpSystemCell>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.expSystemCell), input_name='expSystemCell')), namespace_, eol_))
        if self.vector is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svector>%s</%svector>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.vector), input_name='vector')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class axisOrderType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='axisOrderType', fromsubclass_=False, pretty_print=True):
        ...
        if self.axisOrderFast is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saxisOrderFast>%s</%saxisOrderFast>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.axisOrderFast), input_name='axisOrderFast')), namespace_, eol_))
        if self.axisOrderMedium is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saxisOrderMedium>%s</%saxisOrderMedium>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.axisOrderMedium), input_name='axisOrderMedium')), namespace_, eol_))
        if self.axisOrderSlow is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%saxisOrderSlow>%s</%saxisOrderSlow>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.axisOrderSlow), input_name='axisOrderSlow')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class dimensionType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='dimensionType', fromsubclass_=False, pretty_print=True):
        ...
        if self.numRows is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumRows>%s</%snumRows>%s' % (namespace_, self.gds_format_integer(self.numRows, input_name='numRows'), namespace_, eol_))
        if self.numColumns is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumColumns>%s</%snumColumns>%s' % (namespace_, self.gds_format_integer(self.numColumns, input_name='numColumns'), namespace_, eol_))
        if self.numSections is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumSections>%s</%snumSections>%s' % (namespace_, self.gds_format_integer(self.numSections, input_name='numSections'), namespace_, eol_))
    def build(self, node):
...
class spacingType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='spacingType', fromsubclass_=False, pretty_print=True):
        ...
        if self.spacingRow is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspacingRow>%s</%sspacingRow>%s' % (namespace_, self.gds_format_integer(self.spacingRow, input_name='spacingRow'), namespace_, eol_))
        if self.spacingCol is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspacingCol>%s</%sspacingCol>%s' % (namespace_, self.gds_format_integer(self.spacingCol, input_name='spacingCol'), namespace_, eol_))
        if self.spacingSec is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sspacingSec>%s</%sspacingSec>%s' % (namespace_, self.gds_format_integer(self.spacingSec, input_name='spacingSec'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class originType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='originType', fromsubclass_=False, pretty_print=True):
        ...
        if self.originRow is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%soriginRow>%s</%soriginRow>%s' % (namespace_, self.gds_format_float(self.originRow, input_name='originRow'), namespace_, eol_))
        if self.originCol is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%soriginCol>%s</%soriginCol>%s' % (namespace_, self.gds_format_float(self.originCol, input_name='originCol'), namespace_, eol_))
        if self.originSec is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%soriginSec>%s</%soriginSec>%s' % (namespace_, self.gds_format_float(self.originSec, input_name='originSec'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class limitType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='limitType', fromsubclass_=False, pretty_print=True):
        ...
        if self.limitRow is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slimitRow>%s</%slimitRow>%s' % (namespace_, self.gds_format_float(self.limitRow, input_name='limitRow'), namespace_, eol_))
        if self.limitCol is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slimitCol>%s</%slimitCol>%s' % (namespace_, self.gds_format_float(self.limitCol, input_name='limitCol'), namespace_, eol_))
        if self.limitSec is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slimitSec>%s</%slimitSec>%s' % (namespace_, self.gds_format_float(self.limitSec, input_name='limitSec'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class emdbListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='emdbListType', fromsubclass_=False, pretty_print=True):
        ...
        for entry_ in self.entry:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sentry>%s</%sentry>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(entry_), input_name='entry')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class pdbidListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='pdbidListType', fromsubclass_=False, pretty_print=True):
        ...
        for fittedPDBEntryId_ in self.fittedPDBEntryId:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfittedPDBEntryId>%s</%sfittedPDBEntryId>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(fittedPDBEntryId_), input_name='fittedPDBEntryId')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class pdbidList2Type(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='pdbidList2Type', fromsubclass_=False, pretty_print=True):
        ...
        for pdbEntryId_ in self.pdbEntryId:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%spdbEntryId>%s</%spdbEntryId>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(pdbEntryId_), input_name='pdbEntryId')), namespace_, eol_))
        for pdbChainId_ in self.pdbChainId:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%spdbChainId>%s</%spdbChainId>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(pdbChainId_), input_name='pdbChainId')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
GDSClassesMapping = {
    'aLength': lengthType,
    'acceleratingVoltage': accVoltType,
    'admin': adminType,
    'alpha': anglType,
    'axisOrder': axisOrderType,
    'bLength': lengthType,
    'beta': anglType,
    'buffer': bufferType,
    'cLength': lengthType,
    'cell': slcCellType,
    'cellA': cType,
    'cellAlpha': cAngleType,
    'cellB': slcCType,
    'cellBeta': cAngleType,
    'cellC': slcCType,
    'cellGamma': cAngleType,
    'cellular-component': cellCompType,
    'contourLevel': contourLevelType,
    'deltaPhi': anglType,
    'deltaZ': lengthType,
    'deposition': depType,
    'diameter': diamType,
    'dimensions': slcDimensionType,
    'electronDose': eDoseType,
    'emdEntry': entryType,
    'energyWindow': eWindowType,
    'engSource': engSrcType,
    'expSystem': sciSpeciesType,
    'experiment': expType,
    'externalReference': externalRefType,
    'externalReferences': externalReferencesType,
    'figure': figType,
    'figureSet': figSetType,
    'file': slcFileType,
    'fittedPDBEntryIdList': pdbidListType,
    'fitting': fittingType,
    'fsc': fscType,
    'fscSet': fscSetType,
    'gamma': anglType,
    'helical': helixType,
    'helicalParameters': helixParamType,
    'hostSpecies': sciSpeciesType,
    'imageAcquisition': imgScanType,
    'imaging': imgType,
    ...
    'molWtExp': mwType,
    'molWtTheo': mwType,
    'natSource': natSrcType,
    'nominalCs': csType,
    'nominalDefocusMax': defocusType,
    'nominalDefocusMin': defocusType,
    'nonJournalArticle': nonJrnlArtType,
    'nucleic-acid': nuclAcidType,
    'obsoleteList': emdbListType,
    'origin': originType,
    'pdbEntryIdList': pdbidList2Type,
    'pixelSpacing': pixelSpacingType,
    'pixelX': pixType,
    'pixelY': pixType,
    'pixelZ': pixType,
    'primaryReference': prRefType,
    'processing': processType,
    'protein': proteinType,
    'reconstruction': reconsType,
    'ribosome-eukaryote': riboTypeEu,
    'ribosome-prokaryote': riboTypePro,
    'sample': samplType,
    'sampleComponent': smplCompType,
    'sampleComponentList': smplCompListType,
    'samplingSize': samplSizeType,
    'sciSpeciesName': sciSpeciesType,
    'secondaryReference': prRefType,
    'shell': shellType,
    'singleParticle': singPartType,
    'slice': slcType,
    'sliceSet': slcSetType,
    'spacing': slcSpacingType,
    'specimenConc': samplConcType,
    'specimenPreparation': smplPrepType,
    'statistics': statisticsType,
    'status': statusType,
    'subtomogramAveraging': subTomType,
    'supersededByList': emdbListType,
    'supplement': supplType,
    'temperature': tempType,
    'temperatureMax': tempType,
    'temperatureMin': tempType,
    'threeDCrystalParameters': threeDxtalParamType,
    'tiltAngleMax': tiltType,
    'tiltAngleMin': tiltType,
    'tomography': tomogrType,
    'twoDCrystal': xtal2DType,
    'twoDCrystalParameters': twoDxtalParamType,
    'virus': virusType,
    'vitrification': vitrifType,
}
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from emdb_19 import *\n\n')
